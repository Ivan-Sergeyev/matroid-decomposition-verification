...
\begin{lemma}[adjoining to TU matrices]
...
\begin{corollary}[column properties of TU matrices]
  \label{cor:code_tu_col_props}
  \uses{def:code_tu_matrix,lem:code_tu_row_props}
  Properties listed in Lemma~\ref{lem:code_tu_row_props} also hold with respect to columns.
\end{corollary}

\begin{proof}[Proof sketch]
  \uses{def:code_tu_matrix,lem:code_tu_row_props,lem:code_tu_transpose}
