...
\begin{definition}[matroid $2$-sum]
  ...
  \uses{def:BinaryMatroid,Matrix_2sumComposition}
...
\begin{lemma}[$2$-sum of regular matroids is a regular matroid]
  ...
  \uses{BinaryMatroid.Is2sumOf,def:BinaryMatroid.IsRegular}
...
\begin{proof}[Proof sketch]
  \uses{BinaryMatroid.Is2sumOf,def:BinaryMatroid.IsRegular,lem:code_2_sum_of_TU}
  \leanok
