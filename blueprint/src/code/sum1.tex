...
\begin{definition}[matroid $1$-sum]
  ...
  \uses{StandardRepresentation,Matrix_1sumComposition}
  \lean{StandardRepresentation.Is1sumOf}
  \leanok
...
\begin{lemma}[$1$-sum is commutative]
  ...
  \uses{StandardRepresentation.Is1sumOf}
  \lean{StandardRepresentation_1sum_comm}
  \leanok
  \todo[inline]{add}
\end{lemma}
...
%   \uses{StandardRepresentation.Is1sumOf,def:code_k_sep}
...
\begin{theorem}[$1$-sum of regular matroids is regular]
  \label{StandardRepresentation.Is1sumOf.isRegular}
  \lean{StandardRepresentation.Is1sumOf.isRegular}
  \leanok
  \uses{StandardRepresentation.Is1sumOf,StandardRepresentation.IsRegular}
...
\begin{proof}[Proof sketch]
  \uses{StandardRepresentation.Is1sumOf,StandardRepresentation.IsRegular,lem:code_diagonal_with_tu_blocks,StandardRepresentation_toMatroid_isRegular_iff}
  \leanok
...
\begin{lemma}[left summand of regular $1$-sum is regular]
  \label{StandardRepresentation.Is1sumOf.isRegular_left}
  \lean{StandardRepresentation.Is1sumOf.isRegular_left}
  \uses{StandardRepresentation.Is1sumOf,StandardRepresentation.IsRegular}
  \leanok
  \todo[inline]{add}
\end{lemma}
...
\begin{proof}
  \uses{StandardRepresentation.Is1sumOf,StandardRepresentation.IsRegular, lem:code_submatrix_of_tu}
\end{proof}

\begin{lemma}[right summand of regular $1$-sum is regular]
  \label{StandardRepresentation.Is1sumOf.isRegular_right}
  \lean{StandardRepresentation.Is1sumOf.isRegular_right}
  \uses{StandardRepresentation.Is1sumOf,StandardRepresentation.IsRegular}
  \leanok
  \todo[inline]{add}
\end{lemma}
