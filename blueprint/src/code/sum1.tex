...
\begin{definition}[matroid $1$-sum]
  ...
  \uses{def:BinaryMatroid,Matrix_1sumComposition}
...
\begin{lemma}[$1$-sum of regular matroids is regular]
  ...
  \leanok
  \uses{BinaryMatroid.Is1sumOf,def:BinaryMatroid.IsRegular}
...
\begin{proof}[Proof sketch]
  \uses{BinaryMatroid.Is1sumOf,def:BinaryMatroid.IsRegular,lem:code_diagonal_with_tu_blocks}
  \leanok
