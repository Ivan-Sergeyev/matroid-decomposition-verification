...
\todo[inline]{todo: move ingredients to respective sections, add them as ``uses'' clauses}
...
\begin{proof}[Proof sketch]
  \uses{thm:7.2.1.a.splitter_nonwheel,prop:11.3.3,def:isomorphism,def:1_elem_ext,prop:11.3.5,def:F7,def:contraction}
  \begin{itemize}
...
\begin{proof}[Proof sketch]
  \uses{def:1_elem_ext,prop:10.2.9,thm:11.3.10,case:11.3.7,case:11.3.9}
  \begin{itemize}
